...
library(sessioninfo); library(visdat); library(correlationfunnel)
```
...
train_id <- train_id %>% data.frame
train_transaction <- train_transaction %>% data.frame

test_id <- test_id %>% data.frame
test_transaction <- test_transaction %>% data.frame
```
