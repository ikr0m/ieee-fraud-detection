...
fe_part2 <- tem[, c("acc","card1","card2", "card4", "TransactionAmt", "id_02", "D15","addr1_addr2","decimal","C13","V258","C1","C14",
...
for(j in c('part_1', 'part_2', 'part_3', 'part_4', 'part_5', 'part_6', 'part_7', 'part_8', 'part_9', 'part_10', 'part_11')){
  tem_pca <- prcomp(tem %>% select(!!!rlang::syms(j)) %>% replace(is.na(.), -1), .scale = TRUE)
...
write.csv(sub,"submission-9389.csv",row.names = F)
