...
train$hour = as.factor(train$date2$hour)
test$hour = as.factor(test$date2$hour)
...
tr_idx <- which(train$TransactionDT < quantile(train$TransactionDT, 0.7))
tr_idx2 <- which(train$TransactionDT > quantile(train$TransactionDT, 0.2))
...
fe_part2 <- tem[, c("acc","card1","card2","card3", "card4", "TransactionAmt", "id_02", "D15","addr1_addr2","decimal","C13","V258","C1","C14", "hour", "wday", "PRmailTF")]
...
char_features <- tem[,colnames(tem) %in% 
                       c("ProductCD","card1","card2","card3","card4","card5","card6","addr1","addr2","P_emaildomain",
                         ...
                         "card4__dist1", "addr1__card4", "P_emaildomain__C2", "R_emaildomain__C2", "addr1__card2",
                         "card1__card5", "card5__P_emaildomain", "card5__R_emaildomain", "acc", "DeviceInfo", "hour", "wday", "PRmailTF")]
...
char_f <-  c("ProductCD","card1","card2","card3","card4","card5","card6","addr1","addr2","P_emaildomain",
             ...
             "card1__card5", "card5__P_emaildomain", "card5__R_emaildomain", "DeviceInfo", "hour", "wday", "PRmailTF")
...
rm(tem_pca, tem_ae, x, sample.df.cor); gc(); gc()
...
write.csv(sub,"sub_0.979_70.csv",row.names = F)
